...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2020 at 09:57 PM
...
CREATE TABLE `accessories` (
  ...
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'images/article/no_cover.png',
...
CREATE TABLE `articles` (
  ...
  `cover` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'images/article/no_cover.png',
  `date` date NOT NULL,
...
INSERT INTO `articles` (`id`, `title`, `slug`, `content`, `status`, `cover`, `date`, `author_id`, `created_at`, `updated_at`) VALUES
(2, 'Debitis non in qui quas.', 'debitis-non-in-qui-quas', 'Sint minus et in repellendus. Consequuntur qui recusandae dolorum eveniet odio. Sit enim dolorem et dolor dolore.\n\nPerferendis et quae et voluptatem consequuntur voluptas odio. Dolor culpa dicta ut molestiae. Aliquam voluptatem eos assumenda optio et velit.\n\nNon quia perspiciatis aut quaerat. Non corporis repellat unde ipsa quo soluta et. Quaerat quaerat beatae error tempora dolorem expedita magni saepe. Magnam voluptas dolore ipsum unde quisquam et.\n\nEt numquam et est reiciendis asperiores nesciunt. Aut voluptatem voluptas sunt consequatur. Dolor perferendis dolor occaecati.\n\nUnde error sunt dolor sapiente aperiam dolorum veritatis molestiae. Ad sint nihil et. Voluptates et veritatis quo aspernatur illo exercitationem.', 'Published', 'images/article/no_cover.png', '2020-06-06', 1, '2020-06-06 12:27:58', '2020-06-06 12:27:58'),
(3, 'Doloribus ea nam est.', 'doloribus-ea-nam-est', 'Quam blanditiis ex voluptas aliquam aut non. Quidem sed ut vel in. Perspiciatis voluptas aut perspiciatis aut aspernatur adipisci.\n\nUt voluptate soluta aut est eaque voluptatum. Doloribus labore officiis ullam enim ut et. Fugiat voluptatem exercitationem in qui aut quas non. Ut nostrum dolor omnis est.\n\nDoloribus voluptas voluptas voluptas qui quae pariatur. Laudantium neque nemo eos dolores est. At eum aut quae odio omnis aut et.\n\nIn doloremque sit eos et. Labore voluptatibus perspiciatis consequuntur nam ex rem earum. Fugiat eos ratione dolor.\n\nQuam distinctio maiores nesciunt neque rerum in nulla. Animi explicabo eius omnis officia voluptas ad. Facere laudantium rem officiis in et in tempora accusantium.', 'Published', 'images/article/no_cover.png', '2020-06-06', 1, '2020-06-06 12:27:58', '2020-06-06 12:27:58'),
(4, 'Amet ratione quo porro.', 'amet-ratione-quo-porro', 'Et unde consequuntur facilis nulla non. At consectetur eligendi dolorum quae non exercitationem. Aperiam ipsa rem provident ipsa magnam maiores non. Non est est rem ab pariatur.\n\nPlaceat non consequatur rerum dolorem dolor ad. Et sint ea omnis voluptates. Quos voluptate est et consectetur numquam.\n\nEt magnam quidem ipsum et quis. Voluptatibus quia ipsa maxime consequatur consequuntur in accusamus. Quia et omnis et expedita id ipsam perspiciatis. Quam qui aut consequuntur aperiam et.\n\nLaborum ea ut in explicabo totam recusandae dolores. Consequatur iste et provident voluptatem corrupti sequi repudiandae libero. Omnis sed ratione tempore consequatur.\n\nEst vitae officiis omnis sunt reprehenderit veniam. Sit placeat eos et vel quisquam mollitia. Et id consequuntur velit est atque eaque. Aperiam ratione sunt eligendi ut dignissimos labore nostrum.', 'Published', 'images/article/no_cover.png', '2020-06-06', 1, '2020-06-06 12:27:58', '2020-06-06 12:27:
', 'Published', 'images/article/no_cover.png', '2020-06-06', 1, '2020-06-06 12:27:58', '2020-06-06 12:27:58'),
(9, 'Illo quo rerum enim.', 'illo-quo-rerum-enim', 'Fugiat assumenda ipsum deserunt qui rerum iste hic magni. Debitis et eum fugit voluptate dolorem harum. Et dolores et hic suscipit consequatur nihil.\n\nEt suscipit enim autem quo. Est officia similique quia incidunt. Quia sed qui et tempore suscipit eos cumque.\n\nSit ut maxime excepturi aperiam. Veniam molestiae itaque quasi eos quidem. Deleniti beatae fugiat non voluptatem nobis laborum porro at.\n\nConsequatur et tempore repellendus sed maxime aut officia. Quo similique vitae iure magni voluptatem voluptatem quibusdam. Non nemo et et molestiae. Ut ab eligendi ex consequatur in.\n\nNihil eaque tempora praesentium beatae id ullam magni. Dignissimos debitis dolor asperiores voluptatum. Quae totam architecto molestiae ipsum aliquam.', 'Published', 'images/article/no_cover.png', '2020-06-06', 1, '2020-06-06 12:27:58', '2020-06-06 12:27:58'),
(10, 'Eos hic autem ipsam.', 'eos-hic-autem-ipsam', 'Dolores dolor at atque. Quam aut est deserunt magni id. Laboriosam repellat consequuntur id quaerat iure et.\n\nPariatur dolor vero ut mollitia veritatis nobis illo. Quo ut labore alias consequatur. Consequatur earum error consequuntur id sequi quis. Iste quod non consequatur voluptatibus iusto optio dolorem.\n\nAperiam minima officiis ipsa ea est molestiae. Neque amet molestiae accusantium ab. Quia ut qui sunt sed nihil. Necessitatibus facilis animi amet similique ex adipisci provident molestias.\n\nEt est consectetur et maxime possimus. Velit commodi et ut omnis qui numquam non. Aliquid et aliquam facere autem ullam dolorum magni praesentium. Vitae maxime qui in veniam perspiciatis. Est voluptatem deserunt autem autem architecto.\n\nExplicabo sed et veniam velit nulla nemo. Architecto dolorem et quam ipsam. Deleniti quae consequatur sit.', 'Published', 'images/article/no_cover.png', '2020-06-06', 1, '2020-06-06 12:27:58', '2020-06-06 12:27:58'),
(11, 'Est sapiente qui et.', 'est-sapiente-qui-et', 'Quam incidunt odio quia ut minima non. Enim et facilis perspiciatis voluptatem facilis. Aut harum pariatur sapiente. Et sit dolorem ex dolorum.\n\nHic autem quo voluptatibus cumque. A placeat atque qui dolor rerum modi. Iure id dicta quidem vero eum et.\n\nQuam optio vel iure sequi sequi labore ut. Est in asperiores labore excepturi sunt commodi. Eum qui quisquam eum est vitae.\n\nSaepe praesentium tenetur tenetur ea maiores consequuntur. Molestiae cumque voluptatem ducimus tempore delectus eos doloremque. Odio atque impedit quisquam temporibus quia aliquid. Voluptates ab quae dolorum nostrum dignissimos consequatur a.\n\nDelectus voluptatem deserunt sint eligendi odit veniam voluptatem. Rem ad dolorum totam fuga. Culpa veritatis non laboriosam placeat quidem ipsam. Vel fuga ut dolore laborum eum rem.', 'Published', 'images/article/no_cover.png', '2020-06-06', 1, '2020-06-06 12:27:58', '2020-06-06 12:27:58');
...
INSERT INTO `branches` (`id`, `slug`, `branch_name`, `description`, `image`, `email`, `phone`, `facebook`, `instagram`, `twitter`, `kecamatan_id`, `kabupaten_id`, `provinsi_id`, `address`, `chairman_name`, `latitude`, `longitude`, `created_at`, `updated_at`) VALUES
(3, 'tkci-jakarta', 'TKCI Jakarta', '<p>deskripsi Cabang<br></p>', 'images/branch/images_1591435365_.jpg', 'jakarta@tkci.com', '0123456789', NULL, 'tkci_jakarta', NULL, 3173020, 3173, 31, 'Alamat Lengkap', 'Ketua TKCI Jakarta', '-6.2130655', '106.8468901', '2020-06-06 02:21:11', '2020-06-06 02:21:11'),
(4, 'tkci-bandung', 'TKCI Bandung', '<p>deskripsi cabang bandung<br></p>', 'images/branch/images_1591435364_.jpg', 'bandung@tkci.com', '0123456789', 'tkci_bandung', 'tkci_bandung', 'tkci_bandung', 3204190, 3204, 32, 'alamat lengkap', 'Ketua TKCI Bandung', '-7.0328185', '107.4808172', '2020-06-06 02:22:44', '2020-06-06 02:22:44');
...
(1, 'Pengumuman', 'pengumuman', '2020-06-04 02:33:46', '2020-06-04 02:33:46'),
(2, 'Kajian Islami', 'kajian-islami', '2020-06-04 02:33:46', '2020-06-04 07:24:18');
...
CREATE TABLE `donations` (
  ...
  `donator` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `donations` (`id`, `branch_id`, `date`, `year`, `donator`, `nominal`, `created_at`, `updated_at`) VALUES
(1, 4, '2020-06-03', 2020, 'Donatur1', '50000', '2020-06-06 03:04:43', '2020-06-06 03:04:43'),
(3, 4, '2020-06-06', 2020, 'Nama', '502000', '2020-06-06 03:09:55', '2020-06-06 03:09:55'),
(4, 3, '2020-06-09', 2020, 'Donatur3', '125000', '2020-06-06 03:10:09', '2020-06-06 03:12:24'),
(5, 3, '2020-06-06', 2020, 'Donatur4', '350000', '2020-06-06 03:10:24', '2020-06-06 03:12:31');
...
(3, 'tes', 'tes@gmail.com', 'Subject', 'Isi Pesan', '2020-06-06 12:51:28', '2020-06-06 12:51:28');
...
(71, '2020_05_08_115106_create_articles_table', 1),
(72, '2020_05_08_115155_create_categories_table', 1),
(73, '2020_05_08_115212_create_galleries_table', 1),
(74, '2020_05_08_115226_create_images_table', 1),
(75, '2020_05_08_115301_create_sellers_table', 1),
(76, '2020_05_08_115316_create_accessories_table', 1),
(77, '2020_05_08_115341_create_donations_table', 1),
(78, '2020_05_08_115355_create_branches_table', 1),
(79, '2020_06_03_035342_view_count', 2),
(80, '2020_06_04_143804_article_category', 2),
(81, '2020_06_06_164935_create_messages_table', 3);
...
CREATE TABLE `sellers` (
  ...
  `instagram` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twitter` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'images/user/no_avatar.png',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `username`, `name`, `email`, `email_verified_at`, `password`, `bio`, `role`, `image`, `facebook`, `instagram`, `twitter`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'super_admin', 'Super Admin', 'tkci@gmail.com', NULL, '$2y$10$DnnvCrCQ4DiaHIyv/PCYI.cFxTN1.nFv866KQfGD3NlmK/FY4jaYy', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce condimentum sit amet sem sed vehicula. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia viverra.', 'Super Admin', 'images/user/no_avatar.png', NULL, 'tkci_jakarta', NULL, NULL, '2020-06-04 02:33:46', '2020-06-06 09:07:05');
...
--
ALTER TABLE `accessories`
  ADD CONSTRAINT `seller_key` FOREIGN KEY (`seller_id`) REFERENCES `sellers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `article_category`
--
ALTER TABLE `article_category`
  ADD CONSTRAINT `article_key` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `donations`
  ADD CONSTRAINT `branch_key` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `images`
--
ALTER TABLE `images`
  ADD CONSTRAINT `galery_key` FOREIGN KEY (`gallery_id`) REFERENCES `galleries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
