...
<form action="{{route('seller.store')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Link Akun Facebook" name="facebook" id="facebook">
            </div>
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Link Akun Instagram" name="instagram" id="instagram">
            </div>
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Link Akun Twitter" name="twitter" id="twitter">
            </div>
            <div class="form-group">
